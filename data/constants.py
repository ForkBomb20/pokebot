...
SEREBII_ABBRS = ["", "gs", "rs", "dp", "bw", "xy", "sm", "swsh", "sv"]
...
POKEMON = [
    ...
    "Rayquaza", "Jirachi", "Deoxys-normal", "Deoxys-attack", "Deoxys-defense", "Deoxys-speed",
    # Gen IV
    ...
    "Dialga", "Palkia", "Heatran", "Regigigas", "Giratina-altered", "Giratina-origin",
    "Cresselia", "Phione", "Manaphy", "Darkrai", "Shaymin-land", "Shaymin-sky", "Arceus",
    # Gen V
    ...
    "Zekrom", "Landorus", "Kyurem", "Keldeo-ordinary", "Keldeo-resolute",
    "Meloetta", "Genesect",
    # Gen VI
    ...
    "Kingambit", "Great Tusk", "Scream Tail", "Brute Force", "Flutter Mane",
